// lib/ui/pages/category/view/sub_tab/mail/mail_personal.dart

import 'package:flutter/material.dart';
import 'package:flutter_fillit_app/ui/pages/category/view/target_tab/widgets/vertical_tab.dart';

class MailPersonal extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return VerticalTabWidget(
      ...
      selectedColor: Colors.red, // 선택된 탭 색상
      unselectedColor: Colors.black, // 선택되지 않은 탭 색상
      indicatorColor: Colors.red, // 인디케이터 색상
    );
  }
}
