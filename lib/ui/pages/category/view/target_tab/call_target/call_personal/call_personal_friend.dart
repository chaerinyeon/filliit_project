...
class CallPersonalFriend extends StatefulWidget {
  @override
  _CallPersonalFriendState createState() => _CallPersonalFriendState();
}

class _CallPersonalFriendState extends State<CallPersonalFriend> {
  final List<String> _callPersonalFriendSituations = [
    '옵션 1',
    '옵션 2',
    '옵션 3',
  ];
      ...
      child: Column(
        children: [
          SituationRadioButtons(
            situations: _callPersonalFriendSituations,
